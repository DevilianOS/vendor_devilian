...
DEVILIAN_MOD_VERSION = v1.0.0

ifndef DEVILIAN_BUILD_TYPE
DEVILIAN_BUILD_TYPE := RISING-BETA
...
DEVILIAN_FINGERPRINT := DevilianOS/$(DEVILIAN_VERSION_NUMBER)/$(PLATFORM_VERSION)/$(TARGET_PRODUCT_SHORT)/$(DEVILIAN_BUILD_DATE)
